...
def plot_P_T_input_perturbations(plotvar, model, scale, var, timeframe, mode, diftype, plotsave, y0, ye):
    ...
    # path to  shapefile
    # shapefile_path = '/Users/magaliponds/Library/CloudStorage/OneDrive-VrijeUniversiteitBrussel/1. VUB/02. Coding/01. IRRMIP/03. Data/01. Input files/03. Shapefile/Karakoram/Pan-Tibetan Highlands/Pan-Tibetan Highlands (Liu et al._2022)/Shapefile/Pan-Tibetan Highlands (Liu et al._2022)_P.shp'
    shapefile_path = "/Users/magaliponds/Library/CloudStorage/OneDrive-VrijeUniversiteitBrussel/1. VUB/02. Coding/01. IRRMIP/03. Data/02. QGIS/RGI outlines/GTN-G_O2regions_selected_clipped.shp"
...
#%% Cell 10: Plot the monthly perturbations averaged over all models
...
def plot_P_T_perturbations(models, members, scale, var, timeframe, mode, diftype, plotsave, y0, ye):
    ...
    if plotsave == 'save':
        # os.makedirs(f"o_folder_base/{scale}/{timeframe}/{var}/", exist_ok=True)
        fig_path = '/Users/magaliponds/Library/CloudStorage/OneDrive-VrijeUniversiteitBrussel/1. VUB/02. Coding/01. IRRMIP/04. Figures/98. Final Figures A+1km2/01. Extended_Data'
