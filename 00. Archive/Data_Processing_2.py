...
def individual_figures_zoom(var, model, member):
# Plot precipitation data for each month
    figures = []
    lon_range = (65, 100)
    lat_range = (20, 50)
    
    fn  = f'/Users/magaliponds/Library/CloudStorage/OneDrive-VrijeUniversiteitBrussel/1. VUB/02. Coding/01. IRRMIP/02. Data/01. Input files/{model}.DIF.00{member}.clm.h0.1981_2014.ymondif.nc'
    ds = nc.Dataset(fn, 'r')
    ...
    for month_idx, month_name in enumerate(months):
        ...
        plt.title(f'{model}.00{member}, 1981-2014', fontsize='14')
...
# figures = individual_figures_zoom('RAIN_FROM_ATM', 'CESM2,'1')

def individual_figures_zoom_subplot(var, model,member):
# Plot precipitation data for each month
    figures = []
    lon_range = (65, 100)
    lat_range = (20, 50)
    ...
    for month_idx, month_name in enumerate(months):
        ...
        gl.ylabel_style = {'size': 14} 
        figures.append(fig)
        plt.savefig(f'/Users/magaliponds/Library/CloudStorage/OneDrive-VrijeUniversiteitBrussel/1. VUB/02. Coding/01. IRRMIP/02. Data/04. Output files/{model}/{var}/00{member}/1981_2014.ymondif.{month_idx+1}.png')
        ...
        if month_idx+1==12:
            ...
            plt.savefig(f'/Users/magaliponds/Library/CloudStorage/OneDrive-VrijeUniversiteitBrussel/1. VUB/02. Coding/01. IRRMIP/02. Data/04. Output files/{model}/{var}/00{member}/1981_2014.ymondif.legend.png')
...
figures = individual_figures_zoom_subplot('TSA','CESM2','2')
