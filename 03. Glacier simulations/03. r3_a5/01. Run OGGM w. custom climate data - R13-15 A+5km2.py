...
# # Save each gdir individually
# for gdir in gdirs_3r_a5: #gdirs_test_filtered
#     gdir_path = os.path.join(pkls_subset, f'{gdir.rgi_id}.pkl')
#     with open(gdir_path, 'wb') as f:
#         pickle.dump(gdir, f)
...
# members = [1, 1, 3, 4, 6, 4]
# models = ["W5E5", "IPSL-CM6", "E3SM", "CESM2", "CNRM", "NorESM"]
...
#     ds_base = utils.compile_run_output(
#         gdirs_3r_a5, input_filesuffix='_hydro_baseline_W5E5.000', path=opath_base)
                ...
                for e, ex in enumerate(exp):
                    if member >=1: #skip 0
                        ...
                        try:
                            ...
                            logging.error(f"⚠️ Failed to compile output for {sample_id}\n{traceback.format_exc()}")
...
# members = [4]#1, 3, 4, 6, 4, 1]
# models = ["NorESM"]#"IPSL-CM6", "E3SM", "CESM2", "CNRM", "NorESM", "W5E5"]
...
#             print(error_msg)  # Optional: Print error to console
