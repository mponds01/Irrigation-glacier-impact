...
#%%  Cell 11: Runoff plot including share by runoff component contribution to total (key figure) - averaged over members beforehand (key figure)
...
#%% Cell 12: runoff plot timeline subregions (key figure, extended data)
...
# 
#%% Cell 11b: make hydrological runoff plot with relative difference  
# opath_df_monthly = os.path.join(wd_path,'masters','hydro_output_monthly_subregions_melton_only.csv')
# opath_df_annual = os.path.join(wd_path,'masters','hydro_output_annual_subregions_melton_only.csv')
...
#%% Cell 13: make dataset peak water per glacier aggregated 
...
#%% Cell 13b: Convert to annual, per rgi_ID
...
#%% Cell 13c: stack historical to different ssps
...
#%% Cell 13d:  Process and calculate the peak water time per glacier per member and across 3 members
...
#%% Cell 13e:  Process and calculate the peak water time per subregion per member and across 3 members
...
summary_all.to_csv(opath_df_summary)
#%% Cell 13f: Link rgi subregions to coordinates 
...
#%% Cell 13g: Link rgi_id to coordinates for filtered dataset
...
"""load basin outlines"""
path = "/Users/magaliponds/Library/CloudStorage/OneDrive-VrijeUniversiteitBrussel/1. VUB/02. Coding/01. IRRMIP/03. Data/04. Reference/02. Hydro data/global_30_minute_potential_network_v601_asc/g_basin.asc"
...
#%% Sense check for comparison - create runoff timeline overview
...
#%% Cell 13f: create scatter plot with peak water years (key figure - subpanel 3)
# 
...
#%% Cell 14: Make total runoff overview - 3 panels, calling functions (key figure)
...
#%% Cell 14d: Make total runoff overview - 2 panels, calling functions (key figure)
