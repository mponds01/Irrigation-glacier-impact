...
colors = {
    ...
    # Future scenarios
    #1f78b4
    "noi_fut": ["#90B9D5", "#E4915A"],  # SSP126: orange, SSP370: darker orange
    "irr_fut": ["#3C8DBC", "#D55E00"],  # SSP126: light turquoise, SSP370: lighter turquoise
...
#%% Process hydro data to monthly timeseries
...
#%% Open and process reference data
ssp_colors = {
    'SSP1-1.9': '#A6CEE3',
    'SSP1-2.6': '#3C8DBC',
    'SSP2-4.5': '#E69F00',
...
df_rounce = df_rounce_all.where(df_rounce_all.Region.isin(['Central Asia','South Asia West', 'South Asia East']), drop=True).sum(dim='region')
df_rounce['reg_mass_annual']/= rho*1000#*(10**9)
