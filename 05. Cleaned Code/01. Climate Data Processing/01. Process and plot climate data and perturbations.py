...
This script processes the IRRMIP input data to perturbations (∆Irr-NoIrr) and plots them:
    1. Processes the IRRMIP data to monthly, annual or seasonal perturbations in temperature and precipitation - historic (1985-2014)
    2. Processes the IRRMIP data to monthly, annual or seasonal perturbations in temperature and precipitation - counterfactual (1901-1930)
    3. Processes the baseline climate data (W5E5)
    4. Function for plotting historic perturbations
    5. Function for plotting counterfactual perturbations
    6. Function for plotting baseline data (W5E5)
    7. Loop thought the processing function for all model member combinations in IRRMIP (historic or counterfactual)
    8. Loop through the plotting function for all model member combinations in IRRMIP (historic or counterfactual)
"""
...
diff_folder_in = f"/Users/magaliponds/OneDrive - Vrije Universiteit Brussel/1. VUB/02. Research/01. IRRMIP/03. Data/03. Output files/01. Climate data/02. Perturbations/Precipitation/monthly/CESM2/0/"
...
#function for processing perturbations in temperature and precipitation, for different models, 
#members, variables (P or T), timeframes (resolution), modes (abs or rel (P)), and start and end years (mostly 1985-2014)
def process_P_T_perturbations(model, member, var, timeframe, mode, diftype, y0, ye):
    ...
    base_folder_out = f"/Users/magaliponds/OneDrive - Vrije Universiteit Brussel/1. VUB/02. Research/01. IRRMIP/03. Data/03. Output files/01. Climate data/01. Processed input data/{var}/{timeframe}/{model}/{member}"
    diff_folder_out = f"/Users/magaliponds/OneDrive - Vrije Universiteit Brussel/1. VUB/02. Research/01. IRRMIP/03. Data/03. Output files/01. Climate data/02. Perturbations/{var}/{timeframe}/{model}/{member}"
...
#Creaet a function for creating perturbations in the counterfactual timeframe (1900-2014)
# Not used in the final study in th end
def process_P_T_perturbations_counterfactual(model, member, var, timeframe, mode, diftype):
    ...
    """ Part 0 - Load and open the climate data"""
    # paths to climate data
    folder_in = f"/Users/magaliponds/OneDrive - Vrije Universiteit Brussel/1. VUB/02. Research/01. IRRMIP/03. Data/01. Input files/01. Climate data/{model}/"
...
# Process the baseline data, mostly W5E5, to enable plotting later 
def process_P_T_baseline(model, member, var, timeframe, diftype, y0, ye):
    ...
    # paths to climate data
    if model == "W5E5":
        w5e5_path = '/Users/magaliponds/Library/CloudStorage/OneDrive-VrijeUniversiteitBrussel/1. VUB/02. Research/01. IRRMIP/03. Data/01. Input files/01. Climate data/W5E5/cluster.klima.uni-bremen.de/~oggm/climate/gswp3-w5e5/unflattened/2023.2/monthly'
    ...
    if model == "CRU":
        cru_path = '/Users/magaliponds/Library/CloudStorage/OneDrive-VrijeUniversiteitBrussel/1. VUB/02. Research/01. IRRMIP/03. Data/01. Input files/01. Climate data/CRU/'
...
#Plot the perturbations as created in Cell 1
def plot_P_T_perturbations(model, scale, var, timeframe, mode, diftype, plotsave, y0, ye):
    ...
    base_folder_in = f"/Users/magaliponds/OneDrive - Vrije Universiteit Brussel/1. VUB/02. Research/01. IRRMIP/03. Data/03. Output files/01. Climate data/01. Processed input data/{var}/{timeframe}/{model}/{member}/"
    diff_folder_in = f"/Users/magaliponds/OneDrive - Vrije Universiteit Brussel/1. VUB/02. Research/01. IRRMIP/03. Data/03. Output files/01. Climate data/02. Perturbations/{var}/{timeframe}/{model}/{member}/"
...
#Plot perturbations as calculated in Cell 2 (not used in final study)
...
#Function for plotting the input data
def plot_P_T_input_perturbations(plotvar, model, scale, var, timeframe, mode, diftype, plotsave, y0, ye):
    ...
    if plotvar == "DIF":
        ...
        o_folder_diff = f"/Users/magaliponds/OneDrive - Vrije Universiteit Brussel/1. VUB/02. Research/01. IRRMIP/04. Figures/01. Climate data/01. Input data/{scale}/{var}/{model}/{member}/{plotvar}"
