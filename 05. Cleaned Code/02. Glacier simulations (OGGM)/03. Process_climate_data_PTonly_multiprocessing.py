...
Cell 0c: Set the base parameters
Cell 1: Initialize OGGM with the preferred parameter set up
Cell 1b: Load succesful gdirs (loaded in cell 1b of script 2.1)
Cell 2: Process the perturbations to all the gdirs for P and T separately (perturbations are from input files made in script 1.5)
Cell 3: Run the mass balance model for baseline and perturbed climate timeseries separately for P and T (main output: MB) (historic)
Cell 4: Run the GEM with perturbed climate data for P and T separate (main output: Volume & area evolution) (historic)
"""
# -*- coding: utf-8 -*-import oggm

#%% Cell 0: Load functions
...
# %% Cell 0b: Load custom OGGM functions
...
fig_path = '/Users/magaliponds/Library/CloudStorage/OneDrive-VrijeUniversiteitBrussel/1. VUB/02. Research/01. IRRMIP/04. Figures/02. OGGM simulations/01. Modelled output/3r_a1/'
...
# %% Cell 2: Perturb the climate historical with the processed Irr-perturbations, output is gcm file
...
# %% Cell 3: Run Mass Balance model for the glaciers (V = A*B)
...
# %% Cell 4: Run the climate model baseline and perturbations - Save pkl after running is done , as running takes quite a while
