...
def P_T_overview_plot(var, timeframe, mode, diftype, inputplot, plotsave):
    ...
    ifile_IRR=f"CESM2.IRR.000.clm.h0.1981_2014_selparam_monthly_{mode_suff}.nc"
    ifile_NOI=f"CESM2.NOI.000.clm.h0.1981_2014_selparam_monthly_{mode_suff}.nc"
    ...
    shapefile_path_2 = '/Users/magaliponds/Library/CloudStorage/OneDrive-VrijeUniversiteitBrussel/1. VUB/02. Coding/01. IRRMIP/02. Data/01. Input files/Shapefile/Liu_2022/Pan_Tibetan_shape.shp'
    shp_2 = gpd.read_file(shapefile_path_2)
    shp_2 = shp_2.to_crs(target_crs)
    ...
    for time_idx, timestamp_name in enumerate(timestamps):
       ...
       shp_2.plot(ax=ax, edgecolor='black', linewidth=1, facecolor='none')
   ...
   # Set label and tick parameters for the colorbar
    ...
    if plotsave =='save': 
        if var=="Precipitation":
            plt.savefig(f'/Users/magaliponds/Library/CloudStorage/OneDrive-VrijeUniversiteitBrussel/1. VUB/02. Coding/01. IRRMIP/02. Data/04. Output files/CESM2/1981.2014.{var}.{timeframe}.{mode}.{diftype}.zoom.png', bbox_inches='tight')
        else:
            plt.savefig(f'/Users/magaliponds/Library/CloudStorage/OneDrive-VrijeUniversiteitBrussel/1. VUB/02. Coding/01. IRRMIP/02. Data/04. Output files/CESM2/1981.2014.{var}.{timeframe}.{mode}.abs.zoom.png', bbox_inches='tight')
...
#             for dif in diftypes:
#                 P_T_overview_plot(var, timeframe, mode, dif, 'off', 'save')

P_T_overview_plot("Temperature", "annual", "dif", "abs", 'off', 'nosave')
